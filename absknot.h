...
namespace Unknotter {
    ...
    struct AbsKnot final {
        ...
        void RemoveAt(const size_t* Indicies, size_t IndexCount, std::pair<size_t*, size_t>* ReferenceShifts);
        ...
        void RemoveAtFull(const size_t* Indicies, size_t IndexCount, std::pair<size_t*, size_t>* ReferenceShifts);
        ...
        void RemoveRange(AbsLength Range, std::pair<size_t*, size_t>* ReferenceShifts);
        //Removes the crossovers in the given range. Both the nodes in the range and the nodes corresponding to nodes in the range will be removed. The lower bound of the range is inclusive; the upper bound of the range is not.
        void RemoveRange(size_t LowerIndex, size_t UpperIndex, std::pair<size_t*, size_t>* ReferenceShifts);
        ...
        void AddAt(size_t Index1, size_t Index2, std::pair<size_t*, size_t>* ReferenceShifts);
        ...
        void AddAt(const std::pair<size_t, size_t>* NewCrosses, size_t CrossCount, std::pair<size_t*, size_t>* ReferenceShifts);
        ...
        void AddAtFull(const std::pair<size_t, size_t>* NewCrosses, size_t CrossCount, std::pair<size_t*, size_t>* ReferenceShifts);
